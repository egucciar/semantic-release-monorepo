...
var require_lib = __commonJS({
  "node_modules/json-parse-even-better-errors/lib/index.js"(exports, module2) {
    "use strict";
    var hexify = (char) => {
...
var require_color_name = __commonJS({
  "node_modules/chalk/node_modules/color-name/index.js"(exports, module2) {
    "use strict";
    module2.exports = {
...
var require_conversions = __commonJS({
  "node_modules/chalk/node_modules/color-convert/conversions.js"(exports, module2) {
    "use strict";
...
var require_route = __commonJS({
  "node_modules/chalk/node_modules/color-convert/route.js"(exports, module2) {
    "use strict";
...
var require_color_convert = __commonJS({
  "node_modules/chalk/node_modules/color-convert/index.js"(exports, module2) {
    "use strict";
    var conversions = require_conversions();
...
var require_crypto_random_string = __commonJS({
  "node_modules/tempy/node_modules/crypto-random-string/index.js"(exports, module2) {
    "use strict";
...
var require_unique_string = __commonJS({
  "node_modules/tempy/node_modules/unique-string/index.js"(exports, module2) {
    "use strict";
...
var require_temp_dir = __commonJS({
  "node_modules/tempy/node_modules/temp-dir/index.js"(exports, module2) {
    "use strict";
    var fs4 = require("fs");
    var os2 = require("os");
    ...
    if (!global[tempDirectorySymbol]) {
      Object.defineProperty(global, tempDirectorySymbol, {
        value: fs4.realpathSync(os2.tmpdir())
      });
    }
...
var require_gitignore = __commonJS({
  "node_modules/globby/gitignore.js"(exports, module2) {
    ...
    var readFileP = promisify(fs4.readFile);
...
var require_globby = __commonJS({
  "node_modules/globby/index.js"(exports, module2) {
    ...
    var getPathString = (p) => p.stats instanceof fs4.Stats ? p.path : p;
    ...
    function patch(fs4) {
      ...
      function patchLchmod(fs5) {
        ...
        fs5.lchmodSync = function(path8, mode) {
          var fd = fs5.openSync(path8, constants3.O_WRONLY | constants3.O_SYMLINK, mode);
          var threw = true;
          var ret;
          try {
      ...
      function patchLutimes(fs5) {
        if (constants3.hasOwnProperty("O_SYMLINK") && fs5.futimes) {
          fs5.lutimes = function(path8, at, mt, cb) {
            fs5.open(path8, constants3.O_SYMLINK, function(er, fd) {
              if (er) {
                if (cb)
                  cb(er);
                return;
          ...
          fs5.lutimesSync = function(path8, at, mt) {
            var fd = fs5.openSync(path8, constants3.O_SYMLINK);
            var ret;
            var threw = true;
            try {
...
var require_brace_expansion = __commonJS({
  "node_modules/rimraf/node_modules/brace-expansion/index.js"(exports, module2) {
    "use strict";
...
var require_minimatch = __commonJS({
  "node_modules/rimraf/node_modules/minimatch/minimatch.js"(exports, module2) {
    "use strict";
...
var require_indent_string = __commonJS({
  "node_modules/aggregate-error/node_modules/indent-string/index.js"(exports, module2) {
    "use strict";
...
var require_clean_stack = __commonJS({
  "node_modules/aggregate-error/node_modules/clean-stack/index.js"(exports, module2) {
    "use strict";
    var os2 = require("os");
...
var require_tempy = __commonJS({
  "node_modules/tempy/index.js"(exports, module2) {
    "use strict";
    var fs4 = require("fs");
    var path8 = require("path");
    ...
    module2.exports.file = (options) => {
      ...
      if (options.name) {
        ...
        return path8.join(module2.exports.directory(), options.name);
      }
...
var require_split2 = __commonJS({
  "node_modules/git-log-parser/node_modules/split2/index.js"(exports, module2) {
    "use strict";
...
var require_duplexer2 = __commonJS({
  "node_modules/duplexer2/index.js"(exports, module2) {
    "use strict";
...
var require_stream_combiner2 = __commonJS({
  "node_modules/stream-combiner2/index.js"(exports, module2) {
    "use strict";
...
var require_src3 = __commonJS({
  "node_modules/spawn-error-forwarder/src/index.js"(exports, module2) {
    "use strict";
    function createErr(code, stderr) {
      return new Error(stderr);
    }
    module2.exports = function(child, errFactory) {
...
// index.js
var semantic_release_monorepo_exports = {};
__export(semantic_release_monorepo_exports, {
  default: () => semantic_release_monorepo_default
});
module.exports = __toCommonJS(semantic_release_monorepo_exports);
...
var getPackagePath = (cwd) => import_node_path.default.resolve(toPath(cwd) ?? ".", "package.json");
...
async function findUpMultiple(name, options = {}) {
  let directory2 = import_node_path3.default.resolve(toPath3(options.cwd) || "");
  const { root } = import_node_path3.default.parse(directory2);
  const stopAt = import_node_path3.default.resolve(directory2, options.stopAt || root);
  ...
  while (true) {
    ...
    if (foundPath) {
      matches.push(import_node_path3.default.resolve(directory2, foundPath));
    }
    if (directory2 === stopAt || matches.length >= limit) {
      break;
    }
    directory2 = import_node_path3.default.dirname(directory2);
  }
  return matches;
}
...
function npmRunPath(options = {}) {
  ...
  let previous;
  const cwdString = cwd instanceof URL ? import_node_url4.default.fileURLToPath(cwd) : cwd;
...
var getInputSync = ({ input, inputFile }) => {
  ...
  return (0, import_node_fs5.readFileSync)(inputFile);
};
...
var getInput = ({ input, inputFile }) => {
  ...
  validateInputOptions(input);
  return (0, import_node_fs5.createReadStream)(inputFile);
};
...
var handleArguments = (file, args, options = {}) => {
  ...
  if (import_node_process5.default.platform === "win32" && import_node_path5.default.basename(file, ".exe") === "cmd") {
    args.unshift("/q");
  }
...
var getPackagePath2 = async () => {
  ...
  return (0, import_path2.relative)(gitRoot, (0, import_path2.resolve)(packagePath, ".."));
};
...
var onlyPackageCommits = async (commits2) => {
  ...
  const packageSegments = packagePath.split(import_path2.sep);
  return commitsWithFiles.filter(({ files, subject }) => {
    const packageFile = files.find((file) => {
      const fileSegments = (0, import_path2.normalize)(file).split(import_path2.sep);
...
var logPluginVersion = (type3) => (plugin) => async (pluginConfig, config2) => {
  ...
  if (config2.options.debug) {
    const { version: version2 } = await readPackage((0, import_path3.resolve)(__dirname, "../"));
...
var wrapStep = (stepName, wrapFn, { defaultReturn = void 0, wrapperName = "" } = {}) => {
  return Array(10).fill(null).map((value, index) => {
    const wrapperFn = async function(globalPluginConfig, context) {
      ...
      let plugin;
      import(pluginName).then((module2) => {
