...
// node_modules/read-pkg/node_modules/@babel/helper-validator-identifier/lib/identifier.js
var require_identifier = __commonJS({
  "node_modules/read-pkg/node_modules/@babel/helper-validator-identifier/lib/identifier.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/read-pkg/node_modules/@babel/helper-validator-identifier/lib/keyword.js
var require_keyword = __commonJS({
  "node_modules/read-pkg/node_modules/@babel/helper-validator-identifier/lib/keyword.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/read-pkg/node_modules/@babel/helper-validator-identifier/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/read-pkg/node_modules/@babel/helper-validator-identifier/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_color_name = __commonJS({
  "node_modules/chalk/node_modules/color-name/index.js"(exports, module) {
    "use strict";
    module.exports = {
...
var require_has_flag = __commonJS({
  "node_modules/chalk/node_modules/has-flag/index.js"(exports, module) {
    "use strict";
...
// node_modules/read-pkg/node_modules/@babel/highlight/lib/index.js
var require_lib3 = __commonJS({
  "node_modules/read-pkg/node_modules/@babel/highlight/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/read-pkg/node_modules/@babel/code-frame/lib/index.js
var require_lib4 = __commonJS({
  "node_modules/read-pkg/node_modules/@babel/code-frame/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_hosts = __commonJS({
  "node_modules/hosted-git-info/lib/hosts.js"(exports, module) {
    ...
    var defaults = {
      ...
      edittemplate: ({ domain, user, project, committish, editpath, path: path8 }) => `https://${domain}/${user}/${project}${maybeJoin("/", editpath, "/", maybeEncode(committish || "HEAD"), "/", path8)}`,
      browsetemplate: ({ domain, user, project, committish, treepath }) => `https://${domain}/${user}/${project}${maybeJoin("/", treepath, "/", maybeEncode(committish))}`,
      browsetreetemplate: ({ domain, user, project, committish, treepath, path: path8, fragment, hashformat }) => `https://${domain}/${user}/${project}/${treepath}/${maybeEncode(committish || "HEAD")}/${path8}${maybeJoin("#", hashformat(fragment || ""))}`,
      browseblobtemplate: ({ domain, user, project, committish, blobpath, path: path8, fragment, hashformat }) => `https://${domain}/${user}/${project}/${blobpath}/${maybeEncode(committish || "HEAD")}/${path8}${maybeJoin("#", hashformat(fragment || ""))}`,
      docstemplate: ({ domain, user, project, treepath, committish }) => `https://${domain}/${user}/${project}${maybeJoin("/", treepath, "/", maybeEncode(committish))}#readme`,
      httpstemplate: ({ auth, domain, user, project, committish }) => `git+https://${maybeJoin(auth, "@")}${domain}/${user}/${project}.git${maybeJoin("#", committish)}`,
      filetemplate: ({ domain, user, project, committish, path: path8 }) => `https://${domain}/${user}/${project}/raw/${maybeEncode(committish || "HEAD")}/${path8}`,
      shortcuttemplate: ({ type: type3, user, project, committish }) => `${type3}:${user}/${project}${maybeJoin("#", committish)}`,
    ...
    hosts.github = {
      ...
      blobpath: "blob",
      editpath: "edit",
      filetemplate: ({ auth, user, project, committish, path: path8 }) => `https://${maybeJoin(auth, "@")}raw.githubusercontent.com/${user}/${project}/${maybeEncode(committish || "HEAD")}/${path8}`,
      ...
      extract: (url2) => {
        let [, user, project, type3, committish] = url2.pathname.split("/", 5);
        if (type3 && type3 !== "tree") {
          return;
        }
        if (!type3) {
    ...
    hosts.bitbucket = {
      ...
      blobpath: "src",
      editpath: "?mode=edit",
      edittemplate: ({ domain, user, project, committish, treepath, path: path8, editpath }) => `https://${domain}/${user}/${project}${maybeJoin("/", treepath, "/", maybeEncode(committish || "HEAD"), "/", path8, editpath)}`,
    ...
    hosts.gitlab = {
      ...
      extract: (url2) => {
        const path8 = url2.pathname.slice(1);
    ...
    hosts.gist = {
      ...
      browsetreetemplate: ({ domain, project, committish, path: path8, hashformat }) => `https://${domain}/${project}${maybeJoin("/", maybeEncode(committish))}${maybeJoin("#", hashformat(path8))}`,
      browseblobtemplate: ({ domain, project, committish, path: path8, hashformat }) => `https://${domain}/${project}${maybeJoin("/", maybeEncode(committish))}${maybeJoin("#", hashformat(path8))}`,
      docstemplate: ({ domain, project, committish }) => `https://${domain}/${project}${maybeJoin("/", maybeEncode(committish))}`,
      httpstemplate: ({ domain, project, committish }) => `git+https://${domain}/${project}.git${maybeJoin("#", committish)}`,
      filetemplate: ({ user, project, committish, path: path8 }) => `https://gist.githubusercontent.com/${user}/${project}/raw${maybeJoin("/", maybeEncode(committish))}/${path8}`,
      shortcuttemplate: ({ type: type3, project, committish }) => `${type3}:${project}${maybeJoin("#", committish)}`,
    ...
    hosts.sourcehut = {
      ...
      treepath: "tree",
      blobpath: "tree",
      filetemplate: ({ domain, user, project, committish, path: path8 }) => `https://${domain}/${user}/${project}/blob/${maybeEncode(committish) || "HEAD"}/${path8}`,
...
var require_lib5 = __commonJS({
  "node_modules/hosted-git-info/lib/index.js"(exports, module) {
    ...
    var GitHost = class _GitHost {
      constructor(type3, user, auth, project, committish, defaultRepresentation, opts = {}) {
        Object.assign(this, _GitHost.#gitHosts[type3], {
          type: type3,
          user,
          auth,
          project,
...
var require_fixer = __commonJS({
  "node_modules/normalize-package-data/lib/fixer.js"(exports, module) {
    ...
    function depObjectify(deps, type3, warn) {
      if (!deps) {
        return {};
      }
      ...
      warn("deprecatedArrayDependencies", type3);
      var o = {};
    ...
    function objectifyDeps(data, warn) {
      depTypes.forEach(function(type3) {
        if (!data[type3]) {
          return;
        }
        data[type3] = depObjectify(data[type3], type3, warn);
      });
    }
...
var require_which = __commonJS({
  "node_modules/cross-spawn/node_modules/which/which.js"(exports, module) {
    ...
    var which = (cmd, opt, cb) => {
      ...
      const found = [];
      const step = (i) => new Promise((resolve3, reject3) => {
        if (i === pathEnv.length)
          return opt.all && found.length ? resolve3(found) : reject3(getNotFoundError(cmd));
      ...
      const subStep = (p, i, ii) => new Promise((resolve3, reject3) => {
...
var require_crypto_random_string = __commonJS({
  "node_modules/tempy/node_modules/crypto-random-string/index.js"(exports, module) {
    "use strict";
...
var require_unique_string = __commonJS({
  "node_modules/tempy/node_modules/unique-string/index.js"(exports, module) {
    "use strict";
...
// node_modules/tempy/node_modules/temp-dir/index.js
  ...
  "node_modules/tempy/node_modules/temp-dir/index.js"(exports, module) {
    ...
    if (!global[tempDirectorySymbol]) {
      Object.defineProperty(global, tempDirectorySymbol, {
        value: fs3.realpathSync(os2.tmpdir())
      });
    }
...
var require_merge2 = __commonJS({
  "node_modules/merge2/index.js"(exports, module) {
    ...
    function merge2() {
      const streamsQueue = [];
      const args = slice3.call(arguments);
      let merging = false;
...
var require_fill_range = __commonJS({
  "node_modules/fill-range/index.js"(exports, module) {
    ...
    var pad3 = (input, maxLength, toNumber) => {
      if (maxLength > 0) {
        let dash = input[0] === "-" ? "-" : "";
        if (dash)
          input = input.slice(1);
    ...
    var fillNumbers = (start, end, step = 1, options = {}) => {
      ...
      while (descending ? a >= b : a <= b) {
        if (options.toRegex === true && step > 1) {
          ...
          range.push(pad3(format(a, index), maxLen, toNumber));
        }
...
var require_async2 = __commonJS({
  "node_modules/@nodelib/fs.scandir/out/providers/async.js"(exports) {
    ...
    function read(directory2, settings, callback) {
      if (!settings.stats && constants_1.IS_SUPPORT_READDIR_WITH_FILE_TYPES) {
        readdirWithFileTypes(directory2, settings, callback);
        return;
      }
      readdir(directory2, settings, callback);
    }
    exports.read = read;
    function readdirWithFileTypes(directory2, settings, callback) {
      settings.fs.readdir(directory2, { withFileTypes: true }, (readdirError, dirents) => {
        ...
        const entries = dirents.map((dirent) => ({
          dirent,
          name: dirent.name,
          path: common.joinPathSegments(directory2, dirent.name, settings.pathSegmentSeparator)
        }));
    ...
    function readdir(directory2, settings, callback) {
      settings.fs.readdir(directory2, (readdirError, names) => {
        if (readdirError !== null) {
          callFailureCallback(callback, readdirError);
          return;
        }
        const tasks = names.map((name) => {
          const path8 = common.joinPathSegments(directory2, name, settings.pathSegmentSeparator);
          return (done) => {
...
var require_sync2 = __commonJS({
  "node_modules/@nodelib/fs.scandir/out/providers/sync.js"(exports) {
    ...
    var utils = require_utils4();
    var common = require_common();
    function read(directory2, settings) {
      if (!settings.stats && constants_1.IS_SUPPORT_READDIR_WITH_FILE_TYPES) {
        return readdirWithFileTypes(directory2, settings);
      }
      return readdir(directory2, settings);
    }
    exports.read = read;
    function readdirWithFileTypes(directory2, settings) {
      const dirents = settings.fs.readdirSync(directory2, { withFileTypes: true });
    ...
    exports.readdirWithFileTypes = readdirWithFileTypes;
    function readdir(directory2, settings) {
      const names = settings.fs.readdirSync(directory2);
      return names.map((name) => {
        const entryPath = common.joinPathSegments(directory2, name, settings.pathSegmentSeparator);
...
var require_queue = __commonJS({
  "node_modules/fastq/queue.js"(exports, module) {
    ...
    function queueAsPromised(context, worker, concurrency) {
      ...
      return queue;
      function push(value) {
        var p = new Promise(function(resolve3, reject3) {
...
var require_async3 = __commonJS({
  "node_modules/@nodelib/fs.walk/out/readers/async.js"(exports) {
    ...
    var AsyncReader = class extends reader_1.default {
      ...
      _pushToQueue(directory2, base) {
        const queueItem = { directory: directory2, base };
...
var require_sync3 = __commonJS({
  "node_modules/@nodelib/fs.walk/out/readers/sync.js"(exports) {
    ...
    var SyncReader = class extends reader_1.default {
      ...
      _pushToQueue(directory2, base) {
        this._queue.add({ directory: directory2, base });
      }
      _handleQueue() {
      ...
      _handleDirectory(directory2, base) {
        try {
          const entries = this._scandir(directory2, this._settings.fsScandirSettings);
          for (const entry of entries) {
...
var require_out3 = __commonJS({
  "node_modules/@nodelib/fs.walk/out/index.js"(exports) {
    ...
    exports.Settings = settings_1.default;
    function walk(directory2, optionsOrSettingsOrCallback, callback) {
      if (typeof optionsOrSettingsOrCallback === "function") {
        new async_1.default(directory2, getSettings()).read(optionsOrSettingsOrCallback);
        return;
      }
      new async_1.default(directory2, getSettings(optionsOrSettingsOrCallback)).read(callback);
    }
    exports.walk = walk;
    function walkSync(directory2, optionsOrSettings) {
      const settings = getSettings(optionsOrSettings);
      const provider = new sync_1.default(directory2, settings);
      return provider.read();
    }
    exports.walkSync = walkSync;
    function walkStream(directory2, optionsOrSettings) {
      const settings = getSettings(optionsOrSettings);
      const provider = new stream_1.default(directory2, settings);
      return provider.read();
    }
      ...
      _getStat(filepath) {
        return new Promise((resolve3, reject3) => {
          this._stat(filepath, this._fsStatSettings, (error, stats) => {
            return error === null ? resolve3(stats) : reject3(error);
          });
        });
      }
    };
...
var require_dir_glob = __commonJS({
  "node_modules/dir-glob/index.js"(exports, module) {
    ...
    var getGlob = (directory2, options) => {
      ...
      if (options.files && options.extensions) {
        return options.files.map((x) => path8.posix.join(directory2, addExtensions(x, options.extensions)));
      }
      if (options.files) {
        return options.files.map((x) => path8.posix.join(directory2, `**/${x}`));
      }
      if (options.extensions) {
        return [path8.posix.join(directory2, `**/*.${getExtensions(options.extensions)}`)];
      }
      return [path8.posix.join(directory2, "**")];
    };
...
var require_ignore = __commonJS({
  "node_modules/ignore/index.js"(exports, module) {
    ...
    var Ignore = class {
      ...
      filter(paths3) {
        return makeArray(paths3).filter(this.createFilter());
      }
      // @returns {TestResult}
      test(path8) {
  ...
  "node_modules/globby/gitignore.js"(exports, module) {
    ...
    var mapGitIgnorePatternTo = (base) => (ignore) => {
      if (ignore.startsWith("!")) {
        return "!" + path8.posix.join(base, ignore.slice(1));
      }
      return path8.posix.join(base, ignore);
    };
    var parseGitIgnore = (content, options) => {
      const base = slash(path8.relative(options.cwd, path8.dirname(options.fileName)));
    ...
    var ensureAbsolutePathForCwd = (cwd, p) => {
      ...
      return path8.join(cwd, p);
    };
    var getIsIgnoredPredecate = (ignores, cwd) => {
      return (p) => ignores.ignores(slash(path8.relative(cwd, ensureAbsolutePathForCwd(cwd, p.path || p))));
    };
    ...
    module.exports = async (options) => {
      ...
      const paths3 = await fastGlob("**/.gitignore", {
        ignore: DEFAULT_IGNORE.concat(options.ignore),
        cwd: options.cwd
      });
      const files = await Promise.all(paths3.map((file) => getFile(file, options.cwd)));
      const ignores = reduceIgnore(files);
      return getIsIgnoredPredecate(ignores, options.cwd);
    };
    module.exports.sync = (options) => {
      options = normalizeOptions(options);
      const paths3 = fastGlob.sync("**/.gitignore", {
        ignore: DEFAULT_IGNORE.concat(options.ignore),
        cwd: options.cwd
      });
      const files = paths3.map((file) => getFileSync(file, options.cwd));
      const ignores = reduceIgnore(files);
      return getIsIgnoredPredecate(ignores, options.cwd);
    };
  }
...
var require_globby = __commonJS({
  "node_modules/globby/index.js"(exports, module) {
    ...
    module.exports = async (patterns, options) => {
      ...
      const paths3 = await Promise.all(tasks.map((task) => fastGlob(task.pattern, task.options)));
      return arrayUnion(...paths3).filter((path_) => !filter2(getPathString(path_)));
    };
...
var require_polyfills = __commonJS({
  "node_modules/del/node_modules/graceful-fs/polyfills.js"(exports, module) {
    "use strict";
...
var require_legacy_streams = __commonJS({
  "node_modules/del/node_modules/graceful-fs/legacy-streams.js"(exports, module) {
    "use strict";
    ...
    function legacy(fs3) {
      ...
      function ReadStream(path8, options) {
        ...
        for (var index = 0, length = keys4.length; index < length; index++) {
          var key = keys4[index];
...
var require_clone = __commonJS({
  "node_modules/del/node_modules/graceful-fs/clone.js"(exports, module) {
    "use strict";
...
var require_graceful_fs = __commonJS({
  "node_modules/del/node_modules/graceful-fs/graceful-fs.js"(exports, module) {
    "use strict";
    var fs3 = __require("fs");
...
var require_brace_expansion = __commonJS({
  "node_modules/rimraf/node_modules/brace-expansion/index.js"(exports, module) {
    "use strict";
  ...
  "node_modules/rimraf/node_modules/minimatch/minimatch.js"(exports, module) {
    ...
    function parse2(pattern, isSub) {
      ...
      for (pl = patternListStack.pop(); pl; pl = patternListStack.pop()) {
        ...
        hasMagic = true;
        re = re.slice(0, pl.reStart) + t + "\\(" + tail2;
      }
      clearStateChar();
      if (escaping) {
        re += "\\\\";
    ...
    GlobSync.prototype._finish = function() {
      ...
      if (this.realpath) {
        ...
        this.matches.forEach(function(matchset, index) {
          var set3 = self.matches[index] = /* @__PURE__ */ Object.create(null);
...
var require_indent_string = __commonJS({
  "node_modules/aggregate-error/node_modules/indent-string/index.js"(exports, module) {
    "use strict";
...
// node_modules/aggregate-error/node_modules/clean-stack/index.js
var require_clean_stack = __commonJS({
  "node_modules/aggregate-error/node_modules/clean-stack/index.js"(exports, module) {
    "use strict";
    var os2 = __require("os");
          ...
          if (nextItem.done) {
            ...
            if (resolvingCount === 0) {
              if (!stopOnError && errors.length !== 0) {
                reject3(new AggregateError(errors));
              } else {
                resolve3(result);
              }
            }
...
var require_tempy = __commonJS({
  "node_modules/tempy/index.js"(exports, module) {
    ...
    var getPath = (prefix = "") => path8.join(tempDir, prefix + uniqueString());
    ...
    module.exports.file = (options) => {
      ...
      if (options.name) {
        ...
        return path8.join(module.exports.directory(), options.name);
      }
    ...
    module.exports.directory = ({ prefix = "" } = {}) => {
      const directory2 = getPath(prefix);
      fs3.mkdirSync(directory2);
      return directory2;
    };
...
var require_stream_duplex = __commonJS({
  "node_modules/readable-stream/lib/_stream_duplex.js"(exports, module) {
    ...
    {
      keys4 = objectKeys(Writable.prototype);
      for (v = 0; v < keys4.length; v++) {
        method = keys4[v];
...
// node_modules/git-log-parser/node_modules/split2/index.js
var require_split2 = __commonJS({
  "node_modules/git-log-parser/node_modules/split2/index.js"(exports, module) {
    "use strict";
    var through = require_through2();
    function transform(chunk, enc, cb) {
      var list = chunk.toString("utf8").split(this.matcher), remaining = list.pop(), i;
      if (list.length >= 1) {
...
var require_traverse = __commonJS({
  "node_modules/traverse/index.js"(exports, module) {
    ...
    var objectKeys = Object.keys || function keys4(obj) {
      var res = [];
      for (var key in obj)
        res.push(key);
      return res;
...
// node_modules/git-log-parser/src/fields.js
var require_fields = __commonJS({
  "node_modules/git-log-parser/src/fields.js"(exports) {
    "use strict";
    ...
    exports.map = function() {
      return traverse.reduce(exports.config, function(fields2, node) {
...
// node_modules/argv-formatter/src/index.js
var require_src2 = __commonJS({
  "node_modules/argv-formatter/src/index.js"(exports) {
    "use strict";
    ...
    function options(object) {
      return Object.keys(object).filter(function(key) {
        ...
        return arg.value;
      }).reduce(function(args2, arg) {
        if (arg.single) {
          args2.push(arg.flag);
          if (arg.value !== true) {
            args2.push(arg.value.toString());
          }
        } else {
          if (arg.value !== true) {
            args2.push(arg.flag + "=" + arg.value);
          } else {
            args2.push(arg.flag);
          }
        }
    ...
    function args(object) {
      if (object._) {
        return (Array.isArray(object._) ? object._ : [object._]).map(function(value) {
...
var require_stream_combiner2 = __commonJS({
  "node_modules/stream-combiner2/index.js"(exports, module) {
    "use strict";
...
// node_modules/spawn-error-forwarder/src/index.js
var require_src3 = __commonJS({
  "node_modules/spawn-error-forwarder/src/index.js"(exports, module) {
    "use strict";
...
// node_modules/git-log-parser/src/index.js
var require_src4 = __commonJS({
  "node_modules/git-log-parser/src/index.js"(exports) {
    "use strict";
    var spawn = __require("child_process").spawn;
    var through = require_through2();
    var split2 = require_split2();
    var traverse = require_traverse();
    var fields2 = require_fields();
    var toArgv = require_src2().format;
    var combine = require_stream_combiner2();
    var fwd = require_src3();
    var END = "==END==";
    var FIELD = "==FIELD==";
    ...
    function log(args2, options) {
      return fwd(spawn("git", ["log"].concat(args2), options), function(code, stderr) {
        return new Error("git log failed:\n\n" + stderr);
      }).stdout;
    }
    function args(config2, fieldMap) {
      config2.format = format(fieldMap);
      return toArgv(config2);
    }
    exports.parse = function parseLogStream(config2, options) {
      config2 = config2 || {};
      var map3 = fields2.map();
      return combine.obj([
        log(args(config2, map3), options),
        split2(END + "\n"),
        trim(),
        through.obj(function(chunk, enc, callback) {
          var fields3 = chunk.toString("utf8").split(FIELD);
          callback(null, map3.reduce(function(parsed, field, index) {
            var value = fields3[index];
...
var getPackagePath = (cwd) => path.resolve(toPath(cwd) ?? ".", "package.json");
...
function checkType(type3) {
  if (Object.hasOwnProperty.call(typeMappings, type3)) {
    return;
  }
  throw new Error(`Invalid type specified: ${type3}`);
}
var matchType = (type3, stat) => stat[typeMappings[type3]]();
var toPath2 = (urlOrPath) => urlOrPath instanceof URL ? fileURLToPath2(urlOrPath) : urlOrPath;
async function locatePath(paths3, {
  cwd = process2.cwd(),
  type: type3 = "file",
  allowSymlinks = true,
  concurrency,
...
async function findUpMultiple(name, options = {}) {
  let directory2 = path5.resolve(toPath3(options.cwd) || "");
  const { root } = path5.parse(directory2);
  const stopAt = path5.resolve(directory2, options.stopAt || root);
  const limit = options.limit || Number.POSITIVE_INFINITY;
  const paths3 = [name].flat();
  ...
  const matches = [];
  while (true) {
    const foundPath = await runMatcher({ ...options, cwd: directory2 });
    if (foundPath === findUpStop) {
      break;
    }
    if (foundPath) {
      matches.push(path5.resolve(directory2, foundPath));
    }
    if (directory2 === stopAt || matches.length >= limit) {
      break;
    }
    directory2 = path5.dirname(directory2);
  }
  return matches;
}
...
var timeoutKill = (spawned, signal, reject3) => {
  spawned.kill(signal);
  reject3(Object.assign(new Error("Timed out"), { timedOut: true, signal }));
};
var setupTimeout = (spawned, { timeout, killSignal = "SIGTERM" }, spawnedPromise) => {
  ...
  let timeoutId;
  const timeoutPromise = new Promise((resolve3, reject3) => {
    timeoutId = setTimeout(() => {
      timeoutKill(spawned, killSignal, reject3);
    }, timeout);
  });
...
var getSpawnedPromise = (spawned) => new Promise((resolve3, reject3) => {
...
var handleArguments = (file, args, options = {}) => {
  ...
  if (process7.platform === "win32" && path7.basename(file, ".exe") === "cmd") {
    args.unshift("/q");
  }
...
var import_git_log_parser = __toESM(require_src4());
...
// src/git-utils.js
var import_get_stream2 = __toESM(require_get_stream());
var git = async (args, options = {}) => {
  const { stdout } = await execa("git", args, options);
  return stdout;
};
var getCommitFiles = pipeP(
  (hash) => git(["diff-tree", "--root", "--no-commit-id", "--name-only", "-r", hash]),
  split_default("\n")
);
var getRoot = () => git(["rev-parse", "--show-toplevel"]);

// src/lens-utils.js
var overA = curry_default(async (lens3, f, x) => {
  const value = await f(view_default(lens3, x));
  return set_default(lens3, value, x);
});

// src/options-transforms.js
var commits = lensProp_default("commits");
var nextRelease = lensProp_default("nextRelease");
var version = lensProp_default("version");
var mapCommits = (fn) => overA(commits, async (commits2) => await fn(commits2));
var mapNextReleaseVersion = overA(compose(nextRelease, version));
var withOptionsTransforms = (transforms) => (plugin) => async (pluginConfig, config2) => {
  return plugin(pluginConfig, await composeP(...transforms)(config2));
};

// src/only-package-commits.js
var memoizedGetCommitFiles = memoizeWith_default(identity_default, getCommitFiles);
var getPackagePath2 = async () => {
  const packagePath = await pkgUp();
  const gitRoot = await getRoot();
  return relative(gitRoot, resolve(packagePath, ".."));
};
var withFiles = async (commits2) => {
...
var onlyPackageCommits = async (commits2) => {
  const packagePath = await getPackagePath2();
  const debug = await "debug"("semantic-release:monorepo");
  debug('Filter commits by package path: "%s"', packagePath);
  const commitsWithFiles = await withFiles(commits2);
...
var logFilteredCommitCount = (logger) => async ({ commits: commits2 }) => {
...
var withOnlyPackageCommits = (plugin) => async (pluginConfig, config2) => {
...
// src/version-to-git-tag.js
async function version_to_git_tag_default(version2) {
  if (!version2) {
    return null;
  }
  const { name } = await readPackage();
  return `${name}-v${version2}`;
}

// src/log-plugin-version.js
import { resolve as resolve2 } from "path";
var logPluginVersion = (type3) => (plugin) => async (pluginConfig, config2) => {
  const debug = await "debug"("semantic-release:monorepo");
  if (config2.options.debug) {
    const { version: version2 } = await readPackage(resolve2(__dirname, "../"));
    debug("Running %o version %o", type3, version2);
  }
  return plugin(pluginConfig, config2);
};
var log_plugin_version_default = logPluginVersion;

// src/wrapStep.js
var wrapStep = (stepName, wrapFn, { defaultReturn = void 0, wrapperName = "" } = {}) => {
  return Array(10).fill(null).map((value, index) => {
    const wrapperFn = async function(globalPluginConfig, context) {
      ...
      if (!pluginName) {
        ...
        throw new Error(
          `${wrapperName ? wrapperName : "semantic-release-plugin-decorators"}: Incorrect plugin name type. Expected string but was ${JSON.stringify(
            pluginName
          )}.`
        );
      }
...
var wrapStep_default = wrapStep;

// index.js
var analyzeCommits = wrapStep_default(
  "analyzeCommits",
  compose(log_plugin_version_default("analyzeCommits"), withOnlyPackageCommits),
  {
    wrapperName: "semantic-release-monorepo"
  }
);
var generateNotes = wrapStep_default(
  "generateNotes",
  compose(
    log_plugin_version_default("generateNotes"),
    withOnlyPackageCommits,
    withOptionsTransforms([mapNextReleaseVersion(version_to_git_tag_default)])
  ),
  {
    wrapperName: "semantic-release-monorepo"
  }
);
var success = wrapStep_default(
  "success",
  compose(
    log_plugin_version_default("success"),
    withOnlyPackageCommits,
    withOptionsTransforms([mapNextReleaseVersion(version_to_git_tag_default)])
  ),
  {
...
var fail = wrapStep_default(
  "fail",
  compose(
    log_plugin_version_default("fail"),
    withOnlyPackageCommits,
    withOptionsTransforms([mapNextReleaseVersion(version_to_git_tag_default)])
  ),
  {
...
var tagFormat = `${readPackageSync().name}-v\${version}`;
var config = { analyzeCommits, generateNotes, success, fail, tagFormat };
var semantic_release_monorepo_default = config;
export {
  semantic_release_monorepo_default as default
};
